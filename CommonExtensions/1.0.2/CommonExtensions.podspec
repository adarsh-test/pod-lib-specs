...
Pod::Spec.new do |s|
  ...
  s.version          = '1.0.2'
  s.summary          = 'A short description of CommonExtensions.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/adarsh-test/CommonExtensions'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'adarshmacl' => 'adarshmacl@gmail.com' }
  s.source           = { :git => 'https://github.com/adarsh-test/CommonExtensions.git', :tag => s.version.to_s }
